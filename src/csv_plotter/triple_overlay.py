...
def plot_triplets_with_computed_theory(
    ...
    for base, items in groups.items():
        ...
        x_left = 0.05 * umax
        x_mid = 0.33 * umax
        dy = 0.02 * (3.345 if in_meters else 0.03345)  # deslocamento fixo em função do ylim
        ...
        # você pediu limitar a escala vertical
        if in_meters:          # plot em cm
            ax.set_ylim(0.0, 3.345)   # troque para 4.0 se quiser
        else:                  # plot em m
